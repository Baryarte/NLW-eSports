...
function App() {
  return (
    <div className="max-w-[1344px] mx-auto flex flex-col items-center my-20">
      ...
      <div className="rounded-lg pt-1 bg-nlw-gradient self-stretch mt-8 overflow-hidden">
        <div className="bg-[#2A2634] self-stretch rounded-t-md px-8 py-6 flex justify-between ">
          <div>
